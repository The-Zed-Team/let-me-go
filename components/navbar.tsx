...
export default function Navbar() {
  ...
  return (
  <nav className="w-full px-8 py-2 flex items-center justify-between bg-transparent sticky top-0 z-50" style={{minHeight:'56px', fontFamily: 'Familjen Grotesk, sans-serif', backdropFilter: 'blur(8px)'}}>
      {/* Logo/Brand */}
