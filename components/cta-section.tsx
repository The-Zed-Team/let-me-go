...
const CTASection = () => (
  <section className="w-full flex flex-col items-center mt-40 px-4">
    <div className="flex flex-col items-start w-full max-w-3xl">
      <h2
        className="text-black mb-8 leading-tight text-left"
        style={{
      ...
      <a
        ...
        className="inline-block rounded-full bg-[#3B36F4] px-8 py-3 text-white text-lg font-medium shadow transition hover:bg-[#2823c7] focus:outline-none focus:ring-2 focus:ring-[#3B36F4] focus:ring-offset-2 text-left"
