...
export const metadata = {
  title: 'Download Let Me Goo Smart Application for FREE',
  description: 'Download Let Me Goo for Android or iOS. Notify vehicle owners instantly and get back on the road without the wait.',
  openGraph: {
    title: 'Download Let Me Goo Smart Application for FREE',
    description: 'Notify vehicle owners instantly and get back on the road without the wait.',
    url: 'https://Letmegoo.com/download',
    siteName: 'Let Me Goo',
  },
}
